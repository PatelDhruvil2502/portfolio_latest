...
const App = () => {
  ...
  const headerLightBackgroundColor = useTransform(
    scrollYProgress,
    [0.05, 0.15],
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 h-full w-full">
                    ...
                    <motion.div
                      className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center overflow-hidden text-white"
                      initial="hidden"
